...
- Serialized-data narrowing: `markdown/{round-trip,round-trip-cards}.test.ts`, `nodes-base/import-spec.test.ts`, and `unit/InklingComposer.test.tsx`. The asserted runtime JSON discriminants/fields are produced immediately before the cast; no mock API is fabricated.
