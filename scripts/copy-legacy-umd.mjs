...
// byte-equivalent legacy artifact of the canonical dist/editor.umd.cjs.
...
// artifact's sourceMappingURL resolves to an existing file.
...
console.log('copy-legacy-umd: dist/editor.umd.js retained (byte-equivalent legacy artifact)')
