...
export const WordCountHandleContext = React.createContext<WordCountHandle>(createWordCountHandle())

export const useWordCountHandle = () => React.useContext(WordCountHandleContext)
