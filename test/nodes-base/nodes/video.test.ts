  ...
  describe('data access', function () {
    ...
    it(
      ...
      editorTest(function () {
        ...
        videoNode.src.should.equal('/content/images/2022/12/inkling-lexical.mp4')
        ...
        videoNode.fileName.should.equal('inkling-lexical.mp4')
        ...
        videoNode.thumbnailSrc.should.equal('/content/images/2022/12/inkling-lexical.png')

        videoNode.customThumbnailSrc.should.equal('')
        videoNode.customThumbnailSrc = '/content/images/2022/12/inkling-lexical-custom.png'
        videoNode.customThumbnailSrc.should.equal('/content/images/2022/12/inkling-lexical-custom.png')
  ...
  describe('exportDOM', function () {
    ...
    it(
      ...
      editorTest(function () {
        ...
        output.should.containEql('<figure class="inkling-card inkling-video-card inkling-width-regular"')
        output.should.containEql('<a class="inkling-video-preview" href="https://example.com/my-post"')
        output.should.containEql('background="/content/images/2022/11/inkling-lexical.jpg"')
      }),
    )
    ...
    it(
      ...
      editorTest(function () {
        ...
        ;(() => videoNode.exportDOM(editor, { ...exportOptions, target: 'email' })).should.throw(
    ...
    it(
      ...
      editorTest(function () {
        ...
        const { element } = videoNode.exportDOM(editor, exportOptions)
        const output = (element as HTMLElement).outerHTML
        output.should.containEql('inkling-card inkling-video-card inkling-width-wide')
      }),
    )
  ...
  describe('importDOM', function () {
    it(
      ...
      editorTest(function () {
        ...
        nodes[0].src.should.equal('/content/images/2022/11/inkling-lexical.mp4')
        nodes[0].width!.should.equal(200)
        nodes[0].height!.should.equal(100)
        nodes[0].thumbnailSrc.should.equal('/content/images/2022/11/inkling-lexical.jpg')
    ...
    it(
      ...
      editorTest(function () {
        ...
        nodes[0].customThumbnailSrc.should.equal('/content/images/2022/11/inkling-lexical-custom.jpg')
      }),
    )
