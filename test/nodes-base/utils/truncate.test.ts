...
describe('Utils: truncate', function () {
  ...
  describe('truncateHtml', function () {
    ...
    it('adds ellipsis when text exceeds both lengths', function () {
      ...
      expect(result).toContain('desktop-only')
